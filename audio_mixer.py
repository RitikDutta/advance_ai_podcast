...
def join_audio_video_ffmpeg(video_path, audio_path, output_path, audio_start_time=0):
    """
...
def main():
    ...
    for audio_file in audio_files:
        ...
        output_filename = f"{video_path.stem}_with_{audio_file.stem}{video_path.suffix}"
        output_path = output_folder / output_filename

        # Join audio and video
        join_audio_video_ffmpeg(video_path, audio_file, output_path, audio_start_time)
