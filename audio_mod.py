...
def add_silence_gap(audio, gap_duration_ms=700, interval_ms=60000):
    """
...
def process_audio_files(input_folder='audio', output_suffix='_modified', gap_ms=700, interval_ms=60000):
    """
    ...
    if not wav_files:
        print(f"No WAV files found in '{input_folder}' folder.")
        return
